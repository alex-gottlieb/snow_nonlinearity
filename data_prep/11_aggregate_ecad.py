...
ds = xr.open_dataset(os.path.join(project_dir,'data','interim','ecad.nc'))
...
ndjfm_recomb = xr.merge([ndjfm_tavg,ndjfm_tvar,tvar_all,
                         ...
                         rf,sf])
if os.path.exists(os.path.join(project_dir,'data','processed','ecad','ndjfm_stats.nc')):
    os.remove(os.path.join(project_dir,'data','processed','ecad','ndjfm_stats.nc'))
ndjfm_recomb.to_netcdf(os.path.join(project_dir,'data','processed','ecad','ndjfm_stats.nc'))
